        ...
        <fieldset>
            <div class="row">
               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <cfif (SESSION.BloggerID) gt 0>
                    <label>Name:</label>
                    <input class="form-control" type="text" id="txtNameComment" name="name" 
                    value="#SESSION.bloggerName#">
                    <cfelse>    
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <cfif (SESSION.BloggerID) gt 0>
                        <label>Email:</label>
                        <input class="form-control" type="email" id="txtEmailComment" name="email" 
